...
tree= ET.parse("C://Users//Hp//PycharmProjects//PythonAdvanceProgram//dataformats//emp.xml")
root = tree.getroot()
print(root.tag)
...
tree.write("C://Users//Hp//PycharmProjects//PythonAdvanceProgram//dataformats//updatexml.xml",encoding="utf-8", xml_declaration=True)


#update the xml

tree = ET.parse("C://Users//Hp//PycharmProjects//PythonAdvanceProgram//dataformats//updatexml.xml")
root = tree.getroot()
