#Question: Method Overriding with Inheritance
...
class Manager(Employee):
    def calculate_salary(self):
        print("Calculating manager salary with bonus")

# Runtime polymorphism
emp = Employee()
mgr = Manager()

emp.calculate_salary()   # calls Employee method
mgr.calculate_salary()   # calls overridden method

# Parent class reference pointing to child object
e: Employee = Manager()
e.calculate_salary()     # runtime polymorphism
...
acc2 = BankAccount(6000)

print("Total Balance:", acc1 + acc2)
print("Is acc1 greater than acc2?", acc1 > acc2)
...
d = D()
d.show()          # Method resolved using MRO
print(D.mro())    # Displays Method Resolution Order
